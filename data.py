...
rooms = {
    ...
    "hallway": {
        "description": "A narrow hallway patrolled by droids. East leads to a control room. West to an armoury.",
        "exits": {"south": "cell", "east": "control_room", "west": "armoury"},
        "items": []
    },
    "armoury": {
        "description": "Stacks of weapons and equipment. A blaster sits on a metal shelf.",
        "exits": {"east": "hallway"},
        "items": ["blaster"]
    },
    "control_room": {
    ...
    "escape_pod": {
        "description": "A single escape pod waits. The panel blinks: INSERT KEYCARD.",
